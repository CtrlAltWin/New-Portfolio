...
const Header = () => {
  return (
    <div className="h-20 text-white flex justify-between items-center px-8 border-b border-gray-400 bg-gray-600">
      ...
      <div className="flex gap-[3.5vw] sm:text-[2.7vmin] items-center font-extralight">
        ...
        <Link
          to={"/about"}
          className="hover:underline text-white ease-in duration-200"
        >
          About
        </Link>
      </div>
